---
name: slice-worker-reasoning
description: "Reasoning-tier slice worker for hard conductor-max slices: concurrency, security, migrations, subtle debugging. Use when Jev triage returns tier=reasoning."
model: opus
