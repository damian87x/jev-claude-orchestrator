---
name: slice-worker-fast
description: "Fast-tier slice worker for mechanical conductor-max slices (rename, config, small function, tests for existing behaviour). Use when Jev triage returns tier=fast."
model: haiku
